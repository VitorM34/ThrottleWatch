...
{
    Task<IReadOnlyList<AlertRule>> GetAllAsync(CancellationToken ct);
    ...
    Task<AlertEvent?> GetEventByIdAsync(Guid id, CancellationToken ct);
    Task UpdateEventAsync(AlertEvent alertEvent, CancellationToken ct);
